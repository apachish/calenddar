...
class JsnModelFields extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.title, a.alias, a.note, a.published, a.access, a.accessview' .
					', a.checked_out, a.checked_out_time, a.created_user_id' .
					', a.path, a.parent_id, a.level, a.lft, a.rgt, a.type, a.core, a.required, a.edit, a.profile, a.register, a.search' .
					', a.language'
			)
		);
