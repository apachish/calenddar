...
class JFormFieldParent extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$query	= $db->getQuery(true)
			->select('a.'.(isset($this->element['field_id']) ? $this->element['field_id'] : 'id').' AS value, a.path, a.'.(isset($this->element['field_title']) ? $this->element['field_id'] : 'title').' AS text, a.type, a.level, a.published')
