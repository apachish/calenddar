...
<script type="text/javascript">
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js', function() {
        jQuery(document).ready(function() {
            jQuery('#form-domain').submit(function(event) {
...
<div class="domain-edit front-end-edit">
    ...
    <form id="form-domain" action="<?php echo JRoute::_('index.php?option=com_trn&task=domain.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<input type="hidden" name="jform[extera_filde]" value="<?php echo $this->item->extera_filde; ?>" />
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-domain").appendChild(input);
                    });
                </script>
             <?php endif; ?>
        <div class="control-group">
            <div class="controls">
                ...
                <a class="btn" href="<?php echo JRoute::_('index.php?option=com_trn&task=domainform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
            </div>
        </div>
        
        <input type="hidden" name="option" value="com_trn" />
        <input type="hidden" name="task" value="domainform.save" />
