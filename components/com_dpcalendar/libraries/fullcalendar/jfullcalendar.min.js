...
var defaults = {
	...
	dayNamesShort: ['Sun','Mon','Tue','Wed','Thu','Fri','Sat'],
        jdayNamesShort: ['یکشنبه','دوشنبه','سه شنبه','چهار شنبه','پنج شنبه','جمعه','شنبه'],	
	buttonText: {
...
function BasicView(element, calendar, viewName) {
	...
	function buildTable(showNumbers,isJalaly) {
		...
		html += "<table class='fc-border-separate' style='width:100%' cellspacing='0'>" +
		        "<thead>" +
		        "<tr><input type='hidden' name='month' id='month_current_id' value='"+  parseInt(month+1) +"'>";
		...
		for (i=0; i<rowCnt; i++) {
			...
			for (j=0; j<colCnt; j++) {
				...
				html += "<td" +
				        ...
				        ">" + 
				        "<p><div id='"+formatDate(cellDate, 'yyyy-MM-dd')+"'>";
				if (showNumbers) {					
                                    if(isJalaly){
                                        html += "<div class='fc-day-number'>" + cellDate.getJalaliDate() + "</div></p>";
                                    }else{
                                        html += "<div class='fc-day-number'>" + cellDate.getDate() + "</div></p>";
                                    }                               
				}
