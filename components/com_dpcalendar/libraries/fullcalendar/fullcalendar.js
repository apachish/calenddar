...
function BasicView(element, calendar, viewName) {
	...
	function buildCellHTML(date) {
		...
		if (showNumbers) {
			html += "<div class='fc-day-number'>" + hijricalender_d(formatDate(date, 'yyyy'),formatDate(date, 'MM'),formatDate(date, 'dd') ) + "</div>";//date.getDate()
		}
    ...
    {
        PrevMonthDayMld = [0,31,59,90,120,151,181,212,243,273,304,334];
        iDaySum = 0 ;
        iNewDateElapsed =0 ;
        iBaseYear = 1996 ;
        iBaseDateElapsed = 79 ;
        ...
        iDaySum = iNewDateElapsed - iBaseDateElapsed +(mldyear-iBaseYear) *365 +parseInt((mldyear -iBaseYear ) / 4 );
...
//---------------------------------------------------------------------
    ...
    {
        PrevMonthDayHjr =[0,31,62,93,124,155,186,216,246,276,306,336];
        ...
        itodayday = 1 + daysum;
        isodate = itodayyear+'-'+itodaymonth+'-'+itodayday;
        return  isodate;
    }
    function hijricalender_d ( year , month , day )
    {
        PrevMonthDayHjr =[0,31,62,93,124,155,186,216,246,276,306,336];
        if ( year < 1995 || month < 1 || month > 12 || day > 31 || day < 1 )
            return 0;
