...
class DPCalendarHelper
{
	...
	public static function loadLibrary ($libraries = array('jquery' => true))
	{
		...
		if (isset($libraries['maps']))
		{
			...
			$document->addScript((JBrowser::getInstance()->isSSLConnection() ? "https" : "http") . '://js.maxmind.com/js/geoip.js');
		}

		if (isset($libraries['fullcalendar']))
		{
			$document->addScript(JURI::root() . 'components/com_dpcalendar/libraries/fullcalendar/jfullcalendar.min.js');
