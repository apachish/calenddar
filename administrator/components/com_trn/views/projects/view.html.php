 ...
 */
class TrnViewProjects extends JViewLegacy {
    ...
    protected function addToolbar() {
        ...
        JToolBarHelper::title(JText::_('COM_TRN_TITLE_PROJECTS'), 'projects.png');
        ...
        JHtmlSidebar::setAction('index.php?option=com_trn&view=projects');
	...
	protected function getSortFields()
	{
		...
		'a.create_project' => JText::_('COM_TRN_PROJECTS_CREATE_PROJECT'),
		'a.expiration_project' => JText::_('COM_TRN_PROJECTS_EXPIRATION_PROJECT'),
		'a.name_project' => JText::_('COM_TRN_PROJECTS_NAME_PROJECT'),
		'a.type_project' => JText::_('COM_TRN_PROJECTS_TYPE_PROJECT'),
		);
	}
