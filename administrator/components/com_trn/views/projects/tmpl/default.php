...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_trn&task=projects.saveOrderAjax&tmpl=component';
...
<?php endif;?>
		...
		<table class="table table-striped" id="projectList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_trn&task=project.edit&id='.(int) $item->id); ?>">
