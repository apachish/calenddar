...
class JsnModelUsertype extends JModelAdmin
{
	/**
	 ...
	 * @since   3.1
	*/
	public function getTable($type = 'Usertype', $prefix = 'JsnTable', $config = array())
	{
	...
	protected function populateState()
	{
		...
		$this->setState('usertype.parent_id', $parentId);
	...
	public function getItem($pk = null)
	{
		if ($result = parent::getItem($pk))
		{
			...
			if (empty($result->id))
			{
				$result->parent_id = $this->getState('usertype.parent_id');
			}
	...
	{
		$extension = $this->getState('usertype');
		$jinput = JFactory::getApplication()->input;

		// Get the form.
		$form = $this->loadForm('com_jsn.usertype', 'usertype', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jsn.edit.usertype.data', array());
		...
		$this->preprocessData('com_jsn.usertype', $data);
