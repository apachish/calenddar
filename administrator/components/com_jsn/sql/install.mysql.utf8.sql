...
INSERT IGNORE INTO #__jsn_fields(`id`,`parent_id`,`level`,`title`,`alias`,`path`,`type`,`published`,`core`,`required`,`profile`,`register`,`lft`,`rgt`,`access`,`params`,`edit`,`accessview`) VALUES
	...
	(9,2,2,'AVATAR','avatar','default/avatar','image',1,1,0,1,1,  14,15,1,'{"image_width":200,"image_height":200,"image_thumbwidth":50,"image_thumbheight":50,"image_alt":"Avatar","image_class":"img-circle"}', 1,1),
